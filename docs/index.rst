...
| Buildings                                                           | control   | control  | control  |          |          |          |   |
+=====================================================================+===========+==========+==========+==========+==========+==========+===+
| :ref:`SmartlabThermal-v0 <SmartlabThermal>`                         |:gre:`yes` |:gre:`yes`| :red:`no`|:red:`no` |:red:`no` |:gre:`yes`| E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SmartlabGrid-v0 <SmartlabGrid>`                               |:gre:`yes` |:gre:`yes`| :red:`no`|:gre:`yes`|:gre:`yes`|:gre:`yes`| E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SeilabThermal-v0 <SeilabThermal>`                             |:gre:`yes` |:gre:`yes`| :red:`no`|:red:`no` |:red:`no` |:gre:`yes`| E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SeilabGrid-v0 <SeilabGrid>`                                   |:gre:`yes` |:gre:`yes`| :red:`no`|:gre:`yes`|:gre:`yes`|:gre:`yes`| E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`DatacenterThermostat-v0 <DataCenterThermostat>`               |:gre:`yes` |:red:`no` | :red:`no`|:red:`no` |:red:`no` |:red:`no` | E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`DatacenterTempFan-v0 <DataCenterFull>`                        |:red:`no`  |:red:`no` |:gre:`yes`|:red:`no` |:red:`no` |:red:`no` | E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`OfficesThermostat-v0 <Offices>`                               |:gre:`yes` |:red:`no` | :red:`no`|:red:`no` |:red:`no` |:gre:`yes`| E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SiloFanFCU-v0 <Silo>`                                         |:gre:`yes` |:red:`no` |:gre:`yes`|:red:`no` |:red:`no` |:red:`no` | E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SeminarcenterThermostat-v0 <SeminarcenterThermostat>`         |:gre:`yes` |:red:`no` | :red:`no`|:red:`no` |:red:`no` |:gre:`yes`| E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SeminarcenterFull-v0 <SeminarcenterFull>`                     | :gre:`yes`|:gre:`yes`|:gre:`yes`|:red:`no` |:red:`no` |:gre:`yes`| E+|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SimpleHouseRad-v0 <SimpleHouserad>`                           |:red:`no`  |:gre:`yes`|:red:`no` |:red:`no` |:red:`no` |:gre:`yes`|Mod|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SimpleHouseSlab-v0 <SimpleHouseslab>`                         |:red:`no`  |:gre:`yes`|:red:`no` |:red:`no` |:red:`no` |:gre:`yes`|Mod|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
| :ref:`SwissHouseRad-v0 <SwissHouserad>`                             |:red:`no`  |:gre:`yes`|:red:`no` |:red:`no` |:red:`no` |:gre:`yes`|Mod|
+---------------------------------------------------------------------+-----------+----------+----------+----------+----------+----------+---+
