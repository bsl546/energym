.. _DataCenterThermostat:

DatacenterThermostat
--------------------
...
.. exec::
    ...
    inputs_list = ["Z01_T_Thermostat_sp", "Z02_T_Thermostat_sp"]
...
.. exec::
    ...
    outputs_list = ["Bd_Pw_All", "Bd_Load_CPU", "Ext_Irr", "Ext_RH", "Ext_T", "Fa_Pw_All", "Fa_Pw_HVAC",
    "Z01_RH",
    "Z01_T",
...
The evaluation scenario for the `DatacenterThermostat-v0` model consists of a full year control with the objective of minimizing the power demand, while keeping the zone temperatures between 17 and 26°C.
...
.. toctree::
   ...
   notebooks/DataCenterThermostat