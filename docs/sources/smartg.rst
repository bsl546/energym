...
Smartlab Grid is a 8 zones building located in Spain, Tarragona.  It has a total surface area of 417.12m\ :sup:`2` and a total volume of 1042.83m\ :sup:`3`. 
...
Regarding the electrical part, SMARTLAB system includes a PV array, a community battery and an electric vehicle (EV). 
...
The evaluation scenario for the `SmartlabGrid-v0` model consists of a full year control with the objective of minimizing the grid exchange, while keeping the zone temperatures between 19 and 24°C.
