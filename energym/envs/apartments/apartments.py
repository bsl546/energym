...
INPUTS_SPECS = {
    "P1_T_Thermostat_sp": {
        ...
        "upper_bound": 26,
        "default": 20,
        "description": "Floor 1 thermostat setpoint.",
    },
    "P2_T_Thermostat_sp": {
        "type": "scalar",
        "lower_bound": 16,
        "upper_bound": 26,
        "default": 20,
        "description": "Floor 2 thermostat setpoint.",
    },
    "P3_T_Thermostat_sp": {
        "type": "scalar",
        "lower_bound": 16,
        "upper_bound": 26,
        "default": 20,
        "description": "Floor 3 thermostat setpoint.",
    },
    "P4_T_Thermostat_sp": {
        "type": "scalar",
        "lower_bound": 16,
        "upper_bound": 26,
        "default": 20,
        "description": "Floor 4 thermostat setpoint.",
    },
    "Bd_T_HP_sp": {
        "type": "scalar",
        "lower_bound": 35,
        "upper_bound": 55,
        "default": 45,
        "description": "Heat pump temperature setpoint.",
    },
    "P1_T_Tank_sp": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "default": 50,
        "description": "Floor 1 tank temperature setpoint.",
    },
    "P2_T_Tank_sp": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "default": 50,
        "description": "Floor 2 tank temperature setpoint.",
    },
    "P3_T_Tank_sp": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "default": 50,
        "description": "Floor 3 tank temperature setpoint.",
    },
    "P4_T_Tank_sp": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "default": 50,
        "description": "Floor 4 tank temperature setpoint.",
    },
    "HVAC_onoff_HP_sp": {
        "type": "discrete",
        "size": 2,
    ...
    "Bd_Pw_Bat_sp": {
        ...
        "upper_bound": 1,
        "default": 0,
        "description": "Battery charging/discharging setpoint.",
    },
    "Bd_Ch_EVBat_sp": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1,
        "default": 0,
        "description": "EV battery charging setpoint.",
    },
}
...
OUTPUTS_SPECS = {
    ...
    "P1_T_Tank_sp_out": {
        ...
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 1 temperature setpoint.",
    },
    "P2_T_Tank_sp_out": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 2 temperature setpoint.",
    },
    "P3_T_Tank_sp_out": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 3 temperature setpoint.",
    },
    "P4_T_Tank_sp_out": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 4 temperature setpoint.",
    },
    "Bd_Pw_Bat_sp_out": {
        "type": "scalar",
        "lower_bound": -1,
    ...
    "Bd_DisCh_EVBat": {
        ...
        "lower_bound": 0,
        "upper_bound": 1,
        "description": "EV battery discharging?",
    },
    "Bd_Frac_Vent_sp_out": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "Z01_E_Appl": {
        ...
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 1 appliance energy.",
    },
    "Z02_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 2 appliance energy.",
    },
    "Z03_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 3 appliance energy.",
    },
    "Z04_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 4 appliance energy.",
    },
    "Z05_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 5 appliance energy.",
    },
    "Z06_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 6 appliance energy.",
    },
    "Z07_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 7 appliance energy.",
    },
    "Z08_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Zone 8 appliance energy.",
    },
    "P1_FlFrac_HW": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "Z07_RH": {
        ...
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Zone 7 relative humidity.",
    },
    "Z08_T": {
        "type": "scalar",
        "lower_bound": 10,
    ...
    "Fa_ECh_EVBat": {
        ...
        "lower_bound": 0,
        "upper_bound": 4e3,
        "description": "EV battery charging energy.",
    },
    "Fa_EDCh_EVBat": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 4e3,
        "description": "EV battery discharging energy.",
    },
    "Fa_ECh_Bat": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 4e3,
        "description": "Battery charging energy.",
    },
    "Fa_EDCh_Bat": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 4e3,
        "description": "Battery discharging energy.",
    },
    "Bd_FracCh_EVBat": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "P4_T_Tank": {
        ...
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 4 tank temperature.",
    },
    "P2_T_Tank": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 2 tank temperature.",
    },
    "P1_T_Tank": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 1 tank temperature.",
    },
    "P3_T_Tank": {
        "type": "scalar",
        "lower_bound": 30,
        "upper_bound": 70,
        "description": "Floor 3 tank temperature.",
    },
    "HVAC_Pw_HP": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 12e4,
        "description": "Heat pump power?",
    },
    ...
    "Fa_E_self": {
        ...
        "lower_bound": -2e3,
        "upper_bound": 2e3,
        "description": "Self consumption energy.",
    },
    "Fa_Pw_HVAC": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "Fa_E_Light": {
        ...
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Lighting energy.",
    },
    "Fa_E_Appl": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 5e2,
        "description": "Appliances energy.",
    },
}
