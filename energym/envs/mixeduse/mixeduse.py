...
INPUTS_SPECS = {
    ...
    "Bd_T_AHU2_sp": {
        ...
        "upper_bound": 30,
        "default": 20,
        "description": "AHU 2 temperature setpoint.",
    },
    "Bd_Fl_AHU2_sp": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "Bd_T_AHU1_sp": {
        ...
        "upper_bound": 30,
        "default": 20,
        "description": "AHU 1 temperature setpoint.",
    },
    "Bd_Fl_AHU1_sp": {
        "type": "scalar",
        "lower_bound": 0,
...
OUTPUTS_SPECS = {
    ...
    "Bd_Pw_coil": {
        ...
        "lower_bound": 0,
        "upper_bound": 1.5e4,
        "description": "Coil power consumption?",
    },
    "Bd_Pw_cooling_AHU2": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1e4,
        "description": "AHU 2 cooling power.",
    },
    "Bd_Pw_cooling_HP": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 3e4,
        "description": "Heat pump cooling power.",
    },
    "Bd_Pw_heating_HP": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 3e4,
        "description": "Heat pump heating power.",
    },
    "Bd_T_AHU1": {
        "type": "scalar",
        "lower_bound": 10,
        "upper_bound": 30,
        "description": "AHU 1 temperature.",
    },
    "Bd_T_AHU2": {
        "type": "scalar",
        "lower_bound": 10,
        "upper_bound": 30,
        "description": "AHU 2 temperature.",
    },
    "Ext_Irr": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "Ext_RH": {
        ...
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Outdoor realtive humidity.",
    },
    "Ext_T": {
        "type": "scalar",
        "lower_bound": -10,
    ...
    "Fa_Pw_All": {
        ...
        "lower_bound": 0,
        "upper_bound": 5e4,
        "description": "Total power consumtion.",
    },
    "Fa_Pw_HVAC": {
        "type": "scalar",
        "lower_bound": 0,
