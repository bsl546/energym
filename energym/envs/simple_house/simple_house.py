...
OUTPUTS_SPECS_RAD = {
    "weaBus.HDifHor": {
        ...
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Horizontal diffuse solar radiation.",
    },
    "weaBus.HDirNor": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "weaBus.HGloHor": {
        ...
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Horizontal global radiation.",
    },
    "weaBus.HHorIR": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 1000,
        "description": "Horizontal infrared radiation.",
    },
    "sunRad.y": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "sunHea.Q_flow": {
        ...
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Solar heat flow rate.",
    },
    "preHea.Q_flow": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Prescribed heat flow rate.",
    },
    "heaPum.P": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Heat pump consumed power.",
    },
    "heaPum.QCon_flow": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Actual heating heat flow rate added to fluid.",
    },
    "heaPum.QEva_flow": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Actual cooling heat flow rate removed from fluid.",
    },
    "heaPum.COP": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "heaPum.TConAct": {
        ...
        "lower_bound": 273.15,
        "upper_bound": 343.15,
        "description": "Condenser temperature used to compute efficiency.",
    },
    "heaPum.TEvaAct": {
        "type": "scalar",
        "lower_bound": 273.15,
        "upper_bound": 343.15,
        "description": "Evaporator temperature used to compute efficiency.",
    },
    "rad.Q_flow": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Radiator heat flow rate.",
    },
    "rad.m_flow": {
        "type": "scalar",
        "lower_bound": 0,
        "upper_bound": 10,
        "description": "Radiator mass flow rate.",
    },
    "temRet.T": {
        "type": "scalar",
        "lower_bound": 273.15,
...
OUTPUTS_SPECS_SLAB = {
    ...
    "sla.surf_a.Q_flow": {
        ...
        "lower_bound": 0,
        "upper_bound": 100,
        "description": "Slab heat flow rate.",
    },
    "sla.surf_b.Q_flow": {
        "type": "scalar",
        "lower_bound": 0,
    ...
    "sla.m_flow": {
        ...
        "lower_bound": 0,
        "upper_bound": 10,
        "description": "Slab mass flow rate.",
    },
    "sla.surf_a.T": {
        "type": "scalar",
        "lower_bound": 273.15,
        "upper_bound": 343.15,
        "description": "Slab temperature.",
    },
    "sla.surf_b.T": {
        "type": "scalar",
        "lower_bound": 273.15,
