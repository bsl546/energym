...
equation
  ...
  connect(temRoo.T, conPID.u_m) annotation (Line(points={{-110,0},{-220,0},{
          -220,-120},{-150,-120},{-150,-102}},
                                            color={0,0,127}));
  connect(conPID.y, pumHeaPum.m_flow_in) annotation (Line(points={{-139,-90},{
          -92,-90}},                       color={0,0,127}));
  connect(TSetHea.y[1], conPID.u_s)
    annotation (Line(points={{-178,-90},{-162,-90}}, color={0,0,127}));
  connect(conPID.y, gaiHP.u)
    annotation (Line(points={{-139,-90},{-120,-90},{-120,-120},{-107.6,-120}},
                                                     color={0,0,127}));
  ...
  connect(sla.heatPortEmb[1], theSla.port_a)
    annotation (Line(points={{-30,-40},{-30,-20},{-10,-20}}, color={191,0,0}));
  connect(theSla.port_b, vol.heatPort) annotation (Line(points={{10,-20},{20,
