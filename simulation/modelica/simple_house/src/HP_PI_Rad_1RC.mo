...
equation
  ...
  connect(temRoo.T, conPID.u_m) annotation (Line(points={{-90,20},{-200,20},{
          -200,-80},{-130,-80},{-130,-62}}, color={0,0,127}));
  connect(conPID.y, pumHeaPum.m_flow_in) annotation (Line(points={{-119,-50},{
          -72,-50}},                       color={0,0,127}));
  connect(TSetHea.y[1], conPID.u_s)
    annotation (Line(points={{-158,-50},{-142,-50}}, color={0,0,127}));
  connect(conPID.y, gaiHP.u)
    annotation (Line(points={{-119,-50},{-100,-50},{-100,-80},{-87.6,-80}},
                                                     color={0,0,127}));
