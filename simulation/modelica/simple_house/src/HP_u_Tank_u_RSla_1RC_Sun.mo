...
equation
  ...
  connect(temHP2Hex.port_b, tanSH.portHex_a) annotation (Line(points={{-180,-80},
          {-120,-80},{-120,-120.08},{-60,-120.08}}, color={0,127,255}));
  ...
  connect(tanSH.portHex_b, pumHP.port_a) annotation (Line(points={{-60,-126.8},
          {-120,-126.8},{-120,-180},{-140,-180}}, color={0,127,255}));
