...
equation
  ...
  connect(u, gaiHP.u)
    annotation (Line(points={{-160,-90},{-120,-90},{-120,-120},{-107.6,-120}},
                                                         color={0,0,127}));
  connect(u, pumHeaPum.m_flow_in)
    annotation (Line(points={{-160,-90},{-92,-90}}, color={0,0,127}));
  annotation (Documentation(info="<html>
<p>Example that simulates one room equipped with a water-to-water heat pump.</p>
