...
model HP_u_Slab_1RC_Sun_S18_v0
  ...
  parameter Real COP_nominal = 3
    "Nominal COP";
  parameter Modelica.SIunits.Power P_nominal = 62.7e3
    "Nominal compressor power (at y=1)";
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal = 3*62.7e3
  ...
  parameter Modelica.SIunits.Area slab_surf = 12336
    "Surface area of radiant slab (m^2)";
  parameter Modelica.SIunits.ThermalConductance slab_G_Abo = 127.5e3
  ...
  // Building envelope
  parameter Modelica.SIunits.ThermalConductance therm_cond_G = 6377
    "Envelope Thermal Conductance (W/K)";  // G=Qheat/40
  parameter Modelica.SIunits.HeatCapacity heat_capa_C = 8.88e9
  ...
  parameter Real sun_heat_gain = 308.4 "Sun heat gain";
